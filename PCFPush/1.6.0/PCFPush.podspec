...
PCF_PUSH_VERSION = "1.6.0" # Update this version when you release an update to this repo.  Make sure to run 'pod update' to propagate the change into the Pods project settings.
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/cfmobile/push-ios.git', :tag => "1.6.0" }
